import{Z as N,o as W,h as B,n as G,u as a,q as j,H as q,e as H,$ as K,V,W as Z,b as l,t as E,K as F,y as L,c as e,M as O}from"./khao-ui-svelte-dispatchRemoteControlEvent-4.14.0.js";import{h as Q,N as T}from"./khao-ui-svelte-style-4.14.0.js";import{i as _}from"./khao-ui-icon-4.14.0.js";const A="primary";var D=N("<a> <!></a>");const I={hash:"svelte-1fytfux",code:`.button.svelte-1fytfux {appearance:none;background:transparent;border:none;cursor:pointer;flex-grow:0;flex-shrink:0;font:inherit;padding:0;user-select:none;&:focus {outline:none;}}:host {--khao-button-container-color: var(--khao-sys-color-primary);--khao-button-label-text-color: var(--khao-sys-color-on-primary);--khao-button-state-layer-color: var(--khao-sys-color-on-primary);--khao-button-label-font-weight: var(
