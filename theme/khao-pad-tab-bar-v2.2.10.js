import{Z as $,u as E,h as O,n as S,a as l,l as W,q as f,$ as q,V as j,y,c as i,i as J,Y as Q,b as c,e as Y,O as Z,M as w,Q as A,j as B,L as N,m as C,D as F,E as g,t as G,W as H}from"./khao-ui-svelte-dispatchRemoteControlEvent-4.12.0.js";import{b as m,v as R}from"./khao-ui-svelte-style-4.12.0.js";var U=Object.defineProperty,X=(r,a,t)=>a in r?U(r,a,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[a]=t,p=(r,a,t)=>X(r,typeof a!="symbol"?a+"":a,t);class _{constructor(){p(this,"tablet",1024),p(this,"phone",620),p(this,"isTablet",()=>this.isEqualOrSmaller(this.tablet)),p(this,"isPhone",()=>this.isEqualOrSmaller(this.phone)),p(this,"isEqualOrSmaller",a=>window.innerWidth<=a)}}const aa=new _;var ea=$('<li role="tab"><a> </a></li>');const ta={hash:"svelte-1k1p0fp",code:`:host {--khao-tab-text-size: var(--khao-sys-size-typography-3);--khao-tab-leading-space: var(--khao-sys-size-regular-2);--khao-tab-trailing-space: var(--khao-sys-size-regular-2);--khao-tab-height: var(--khao-sys-size-regular-6);--khao-tab-width: var(--khao-sys-size-regular-8);--khao-tab-container-shape: var(--khao-sys-shape-corner-small);--khao-tab-active-height: var(--khao-sys-size-regular-7);--khao-tab-text-color: var(--khao-sys-color-neutral30);--khao-tab-state-layer-color: var(--khao-sys-color-neutral50);--khao-tab-border-color: var(--khao-sys-color-secondary);--khao-tab-hover-state-layer-opacity: var(
