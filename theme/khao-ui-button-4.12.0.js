import{Z as W,u as N,h as B,n as G,a,q as E,H as j,e as q,$ as H,V as K,W as V,E as l,t as Z,K as F,y as L,c as e,M as O}from"./khao-ui-svelte-dispatchRemoteControlEvent-4.12.0.js";import{b as Q,v as T}from"./khao-ui-svelte-style-4.12.0.js";import{t as _}from"./khao-ui-icon-4.12.0.js";const A="primary";var D=W("<a> <!></a>");const I={hash:"svelte-1fytfux",code:`.button.svelte-1fytfux {appearance:none;background:transparent;border:none;cursor:pointer;flex-grow:0;flex-shrink:0;font:inherit;padding:0;user-select:none;&:focus {outline:none;}}:host {--khao-button-container-color: var(--khao-sys-color-primary);--khao-button-label-text-color: var(--khao-sys-color-on-primary);--khao-button-state-layer-color: var(--khao-sys-color-on-primary);--khao-button-label-font-weight: var(
