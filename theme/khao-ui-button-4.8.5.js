import{Z as W,u as N,h as B,n as G,a,q as E,H as j,e as q,V as H,K as J,y as K,$ as V,W as Z,E as l,t as F,c as e,M as L}from"./khao-ui-svelte-dispatchRemoteControlEvent-4.8.5.js";import{b as O,v as Q}from"./khao-ui-svelte-style-4.8.5.js";import{J as T}from"./khao-ui-icon-4.8.5.js";const _="primary";var A=W("<a> <!></a>");const D={hash:"svelte-1fytfux",code:`.button.svelte-1fytfux {appearance:none;background:transparent;border:none;cursor:pointer;flex-grow:0;flex-shrink:0;font:inherit;padding:0;user-select:none;&:focus {outline:none;}}:host {--khao-button-container-color: var(--khao-sys-color-primary);--khao-button-label-text-color: var(--khao-sys-color-on-primary);--khao-button-state-layer-color: var(--khao-sys-color-on-primary);--khao-button-label-font-weight: var(
