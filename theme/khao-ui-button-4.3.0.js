import{Y as B,J as G,e as J,h as M,K as a,S as W,N as O,D as T,B as j,l as D,n as K,k as S,G as X,X as r,T as Y}from"./svelte-chunk-BjrW25s9.js";import{O as _,i}from"./svelte-chunk-DVcgQaFz.js";import{_ as E}from"./svelte-chunk-BEIVXLNk.js";import{a as F}from"./svelte-chunk-DZxOmBye.js";import{J as L}from"./khao-ui-icon-4.3.0.js";const Q="primary";var q=B("<a> <!></a>");const A={hash:"svelte-1fytfux",code:`.button.svelte-1fytfux {appearance:none;background:transparent;border:none;cursor:pointer;flex-grow:0;flex-shrink:0;font:inherit;padding:0;user-select:none;&:focus {outline:none;}}:host {--khao-button-container-color: var(--khao-sys-color-primary);--khao-button-label-text-color: var(--khao-sys-color-on-primary);--khao-button-state-layer-color: var(--khao-sys-color-on-primary);--khao-button-label-font-weight: var(
