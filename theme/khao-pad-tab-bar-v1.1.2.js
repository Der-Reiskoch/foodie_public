import{Z as $,u as E,h as O,n as S,a as l,l as W,q as f,V as q,y,$ as j,i as J,Y as Q,e as Y,L as Z,c as i,b as c,Q as A,j as B,O as N,D as C,M as w,E as g,t as F,W as G,k as H}from"./khao-ui-svelte-dispatchRemoteControlEvent-4.6.0.js";import{b as m,v as R}from"./khao-ui-svelte-style-4.6.0.js";var U=Object.defineProperty,X=(r,a,t)=>a in r?U(r,a,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[a]=t,p=(r,a,t)=>X(r,typeof a!="symbol"?a+"":a,t);class _{constructor(){p(this,"tablet",1024),p(this,"phone",620),p(this,"isTablet",()=>this.isEqualOrSmaller(this.tablet)),p(this,"isPhone",()=>this.isEqualOrSmaller(this.phone)),p(this,"isEqualOrSmaller",a=>window.innerWidth<=a)}}const aa=new _;var ea=$('<li role="tab"><a> </a></li>');const ta={hash:"svelte-1k1p0fp",code:`:host {--khao-tab-text-size: var(--khao-sys-size-typography-3);--khao-tab-leading-space: var(--khao-sys-size-regular-2);--khao-tab-trailing-space: var(--khao-sys-size-regular-2);--khao-tab-height: var(--khao-sys-size-regular-6);--khao-tab-width: var(--khao-sys-size-regular-8);--khao-tab-container-shape: var(--khao-sys-shape-corner-small);--khao-tab-active-height: var(--khao-sys-size-regular-7);--khao-tab-text-color: var(--khao-sys-color-neutral30);--khao-tab-state-layer-color: var(--khao-sys-color-neutral50);--khao-tab-border-color: var(--khao-sys-color-secondary);--khao-tab-hover-state-layer-opacity: var(
      ...
      100% 100%,
      var(--khao-tab-bar-scroll-shadow-size) 100%;height:calc(var(--khao-tab-bar-height)-20px);}`};function ia(r,a){O(a,!1),S(r,la);let t=J();Q(()=>{ra(c(t))});let s=l(a,"tabs",12,""),n=l(a,"activeTabKey",12,""),h=l(a,"maxWidth",12,"860px"),b=l(a,"centered",12,"false"),v=l(a,"scrollShadow",12,"false");W();var o=sa(),d=f(o);{var u=e=>{var x=A(),K=B(x);N(K,1,()=>JSON.parse(s()),H,(T,k)=>{let L=()=>c(k).label,z=()=>c(k).key,M=()=>c(k).href,P=()=>c(k).title,V=()=>c(k).size;const D=G(()=>n()===z()?"true":"false");I(T,{get key(){return z()},get label(){return L()},get href(){return M()},get title(){return P()},get active(){return c(D)},get size(){return V()}})}),y(e,x)};Y(d,e=>{s()&&e(u)})}return w(o),Z(o,e=>C(t,e),()=>c(t)),q(()=>{m(o,1,`tab-bar ${b()==="true"?"tab-bar-centered":""} ${v()==="true"?"tab-bar-scroll-shadow":""}`,"svelte-rznysc"),R(o,`max-width: ${h()??""}`)}),y(r,o),j({get tabs(){return s()},set tabs(e){s(e),i()},get activeTabKey(){return n()},set activeTabKey(e){n(e),i()},get maxWidth(){return h()},set maxWidth(e){h(e),i()},get centered(){return b()},set centered(e){b(e),i()},get scrollShadow(){return v()},set scrollShadow(e){v(e),i()}})}customElements.define("khao-tab-bar",E(ia,{tabs:{},activeTabKey:{},maxWidth:{},centered:{},scrollShadow:{}},[],[],!0));
