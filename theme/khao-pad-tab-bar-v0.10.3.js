import{B as W,M as K,v as T,J as d,$ as O,g as j,D as u,H as q,X as c,W as f,K as y,N as B,j as m,R as g,A as w,i as k,c as p,L as E,k as I,x as L,C as N,y as H,P as J,o as M,e as R,f as X}from"./svelte-chunk-DfnyCMNC.js";import{u as $}from"./svelte-chunk-D6YF6ztN.js";var A=Object.defineProperty,C=(s,t,a)=>t in s?A(s,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):s[t]=a,v=(s,t,a)=>C(s,typeof t!="symbol"?t+"":t,a);class D{constructor(){v(this,"tablet",1024),v(this,"phone",620),v(this,"isTablet",()=>this.isEqualOrSmaller(this.tablet)),v(this,"isPhone",()=>this.isEqualOrSmaller(this.phone)),v(this,"isEqualOrSmaller",t=>window.innerWidth<=t)}}const Q=new D;function U(s){j(s,"svelte-1k1p0fp",`:host{--khao-tab-text-size:var(--khao-sys-size-typography-3);--khao-tab-leading-space:var(--khao-sys-size-regular-2);--khao-tab-trailing-space:var(--khao-sys-size-regular-2);--khao-tab-height:var(--khao-sys-size-regular-6);--khao-tab-width:var(--khao-sys-size-regular-8);--khao-tab-container-shape:var(--khao-sys-shape-corner-small);--khao-tab-active-height:var(--khao-sys-size-regular-7);--khao-tab-text-color:var(--khao-sys-color-neutral30);--khao-tab-state-layer-color:var(--khao-sys-color-neutral50);--khao-tab-border-color:var(--khao-sys-color-secondary);--khao-tab-hover-state-layer-opacity:var(
      ...
      100% 100%,
      var(--khao-tab-bar-scroll-shadow-size) 100%;height:calc(var(--khao-tab-bar-height)-20px)}`)}function x(s,t,a){const r=s.slice();return r[7]=t[a].label,r[8]=t[a].key,r[9]=t[a].href,r[10]=t[a].title,r[11]=t[a].size,r}function z(s){let t,a,r=$(JSON.parse(s[0])),e=[];for(let o=0;o<r.length;o+=1)e[o]=S(x(s,r,o));const i=o=>p(e[o],1,1,()=>{e[o]=null});return{c(){for(let o=0;o<e.length;o+=1)e[o].c();t=L()},m(o,n){for(let l=0;l<e.length;l+=1)e[l]&&e[l].m(o,n);f(o,t,n),a=!0},p(o,n){if(n&3){r=$(JSON.parse(o[0]));let l;for(l=0;l<r.length;l+=1){const h=x(o,r,l);e[l]?(e[l].p(h,n),k(e[l],1)):(e[l]=S(h),e[l].c(),k(e[l],1),e[l].m(t.parentNode,t))}for(N(),l=r.length;l<e.length;l+=1)i(l);E()}},i(o){if(!a){for(let n=0;n<r.length;n+=1)k(e[n]);a=!0}},o(o){e=e.filter(Boolean);for(let n=0;n<e.length;n+=1)p(e[n]);a=!1},d(o){o&&g(t),H(e,o)}}}function S(s){let t,a;return t=new P({props:{key:s[8],label:s[7],href:s[9],title:s[10],active:s[1]===s[8]?"true":"false",size:s[11]}}),{c(){J(t.$$.fragment)},m(r,e){M(t,r,e),a=!0},p(r,e){const i={};e&1&&(i.key=r[8]),e&1&&(i.label=r[7]),e&1&&(i.href=r[9]),e&1&&(i.title=r[10]),e&3&&(i.active=r[1]===r[8]?"true":"false"),e&1&&(i.size=r[11]),t.$set(i)},i(r){a||(k(t.$$.fragment,r),a=!0)},o(r){p(t.$$.fragment,r),a=!1},d(r){R(t,r)}}}function _(s){let t,a,r,e=s[0]&&z(s);return{c(){t=u("ul"),e&&e.c(),c(t,"class",a="tab-bar "+(s[3]==="true"?"tab-bar-centered":"")+" "+(s[4]==="true"?"tab-bar-scroll-shadow":"")+" svelte-rznysc"),c(t,"role","tablist"),w(t,"max-width",s[2])},m(i,o){f(i,t,o),e&&e.m(t,null),s[6](t),r=!0},p(i,[o]){i[0]?e?(e.p(i,o),o&1&&k(e,1)):(e=z(i),e.c(),k(e,1),e.m(t,null)):e&&(N(),p(e,1,1,()=>{e=null}),E()),(!r||o&24&&a!==(a="tab-bar "+(i[3]==="true"?"tab-bar-centered":"")+" "+(i[4]==="true"?"tab-bar-scroll-shadow":"")+" svelte-rznysc"))&&c(t,"class",a),(!r||o&4)&&w(t,"max-width",i[2])},i(i){r||(k(e),r=!0)},o(i){p(e),r=!1},d(i){i&&g(t),e&&e.d(),s[6](null)}}}function tt(s,t,a){let r;I(()=>{Z(r)});let{tabs:e=""}=t,{activeTabKey:i=""}=t,{maxWidth:o="860px"}=t,{centered:n="false"}=t,{scrollShadow:l="false"}=t;function h(b){X[b?"unshift":"push"](()=>{r=b,a(5,r)})}return s.$$set=b=>{"tabs"in b&&a(0,e=b.tabs),"activeTabKey"in b&&a(1,i=b.activeTabKey),"maxWidth"in b&&a(2,o=b.maxWidth),"centered"in b&&a(3,n=b.centered),"scrollShadow"in b&&a(4,l=b.scrollShadow)},[e,i,o,n,l,r,h]}class et extends K{constructor(t){super(),T(this,t,tt,_,O,{tabs:0,activeTabKey:1,maxWidth:2,centered:3,scrollShadow:4},G)}get tabs(){return this.$$.ctx[0]}set tabs(t){this.$$set({tabs:t}),d()}get activeTabKey(){return this.$$.ctx[1]}set activeTabKey(t){this.$$set({activeTabKey:t}),d()}get maxWidth(){return this.$$.ctx[2]}set maxWidth(t){this.$$set({maxWidth:t}),d()}get centered(){return this.$$.ctx[3]}set centered(t){this.$$set({centered:t}),d()}get scrollShadow(){return this.$$.ctx[4]}set scrollShadow(t){this.$$set({scrollShadow:t}),d()}}customElements.define("khao-tab-bar",W(et,{tabs:{},activeTabKey:{},maxWidth:{},centered:{},scrollShadow:{}},[],[],!0));
